	...
	<HEAD>
		...
		function changetype(){
		  if(document.Form1.keyword.value=="jerrynew"){
		     ...
		     Pub.submitActionWithForm('Form2','${pageContext.request.contextPath }/elecSystemDDLAction_editUI.action','Form1');
		  }else{
		    var textStr="";
     ...
     function saveDict(){
	      ...
	      document.Form2.action="${pageContext.request.contextPath }/elecSystemDDLAction_save.action";
			...
			<TBODY>
				...
				<tr>
					...
					<select name="keyword" class="bg" style="width:180px" onchange="changetype()">
					 ...
					 -->
					<s:select list="#elecSystemDDLPageBean.recordList" id="keyword" name="keyword" 

...
<head>
	...
	<script type="text/javascript">
		function onSortByChange(selectValue){
			if(selectValue == 0){
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 文章列表
        </div>
...
<s:form action="informationAction_list"><%--该form是为了提交筛选查询参数 post方式--%>
<div id="MainArea">
	<div id="PageHead"></div>
	<center>
		<div class="ItemBlock_Title1" style="width: 98%;">
			...
			<span style="margin-left:30px;">
				<s:a action="informationAction_addUI">
		...
		<div class="ForumPageTableBorder">
			<table width="100%" border="1" cellspacing="0" cellpadding="0">
				...
				<tr align="center" valign="middle">
					...
					<td class="ForumPageTableTitle">文章标题</td>
					<td width="70" class="ForumPageTableTitle">作者</td>
					<td width="80" class="ForumPageTableTitle">发布时间</td>
					<td width="140" class="ForumPageTableTitle">所属栏目</td>
					<td width="40" class="ForumPageTableTitle">显示</td>
				...
				<tbody class="dataContainer">
					...
					<tr height="35" id="d0" class="template">
						<td></td>
						<td class="Topic">
							<s:a cssClass="Default" action="informationAction_editUI?id=%{id}">${title}</s:a>
						</td>
						<td width="70" class="ForumTopicPageDataLine" align="center">
							${author}
						</td>
						<td width="80" class="ForumTopicPageDataLine" align="center"><s:date name="postDate" format="yyyy-MM-dd HH:mm:ss"/></td>
						<td width="140" class="ForumTopicPageDataLine">
							<s:iterator value="channels">
								${name}；
							</s:iterator>
						</td>
						<td width="40" class="ForumTopicPageDataLine" align="center">

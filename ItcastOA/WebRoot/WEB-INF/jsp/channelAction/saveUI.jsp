...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 栏目信息
        </div>
...
<div id=MainArea>
    ...
    <s:form action="channelAction_%{id==null ? 'add' : 'edit'}">

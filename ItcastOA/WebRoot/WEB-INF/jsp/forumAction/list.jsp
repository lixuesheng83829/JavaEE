						...
						<td class="ForumPageTableDataLine">
							<ul class="ForumPageTopicUl">
								<li><font color="#444444">┌ 主题：</font> 
									<s:a action="topicAction_show?id=%{lastTopic.id}" cssClass="ForumTitle">${lastTopic.title}</s:a>
								</li>
								<li><font color="#444444">├ 作者：</font> ${lastTopic.author.name}</li>
								<li><font color="#444444">└ 时间：</font><s:date name="%{lastTopic.postTime}" format="yyyy-MM-dd HH:mm:ss"/>
								</li>
							</ul>
						</td>
						<td width="3"></td>
